...
<head>
    ...
    <title>Calendário - Free Men's Barbearia</title>
...
<body>
    <aside class="sidebar">
        ...
        <ul class="menu">
            ...
            <li><a href="calendario.php" class="active"><i class="fa-solid fa-calendar"></i> Calendário</a></li>
        </ul>
